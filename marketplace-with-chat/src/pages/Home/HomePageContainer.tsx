...
class HomePageContainer extends React.Component<DefaultProps, DefaultState, object> {
  ...
  public render() {
    return <HomePage onTopProductClick={this.handleTopProductClick} onTopVendorClick={this.handleTopVendorClick} topProducts={this.state.topProducts} topVendors={this.state.topVendors} />;
  }
}
