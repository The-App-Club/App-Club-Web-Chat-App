      ...
      <div className="ProductPage">
        <div id="product-information-container">
          <div className="row">
            ...
            <div className="col-sm-4">
              <ProductCard product={product} size={ProductCardSize.Large} hoverable={false} softEdges={true} />
            </div>
            <div className="col-sm-4"></div>
          </div>
        </div>
        ...
        <div id="vendor-information-container">
          ...
          <div className="row">
            <div className="col-sm-4"></div>
            <div className="col-sm-4">
              <UserCard user={product.vendor} color={Color.Gray} borderless={false} onClick={this.handleVendorClick} hoverable={true} size={UserCardSize.Large} displayName={false} useBottomMarginForImage={true} changeBackgroundColorOnHover={false} />

              <button type="button" id="chat-btn" className="btn btn-primary btn-block" onClick={this.handleChatButtonClick} style={{ backgroundColor: product.vendor.chatPreferences.chatButtonColorHex }}>
