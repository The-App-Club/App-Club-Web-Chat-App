...
class ProductPageContainer extends React.Component<DefaultProps, DefaultState, object> {
  ...
  public render() {
    ...
    return <ProductPage onVendorClick={this.handleVendorClick} product={this.state.product} talkSession={this.state.talkSession} talkConversation={this.state.talkConversation} />;
  }
}
