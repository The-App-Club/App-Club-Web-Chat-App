...
class UserProfilePageContainer extends React.Component<DefaultProps, DefaultState, object> {
  ...
  public render() {
    ...
    return <UserProfilePage handleProductclick={this.handleProductClick} profileUser={this.state.profileUser} talkSession={this.state.talkSession} talkConversation={this.state.talkConversation} />;
  }
}
